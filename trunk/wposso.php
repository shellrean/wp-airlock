<?php
/**
 * Plugin Name: Simple Single Sign On
 * Plugin URI: http://dash10.digital
 * Version: 1.4.6 
 * Description: Provides Simple Single Sign On integration with another WordPress instance running WP OAuth Server or a generic OAuth 2 server.
